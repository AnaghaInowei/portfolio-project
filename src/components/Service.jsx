...
// services
    ...
    return (
        <section id="services" className="flex flex-col justify-center gap-6 items-center text-center px-4 py-6">
            <div>
                <h2 className="text-4xl text-blue-500 mb-5" style={{ fontFamily: "cursive" }}>My Services</h2>
            ...
            <div className="mt-4 flex flex-col md:flex-row justify-between items-start md:items-center bg-blue-50 gap-4 w-full px-4 py-7 rounded-2xl">
                <div className="text-left md:max-w-2/3">
                    <h3 className="font-bold text-blue-500 text-2xl mb-4 " style={{ fontFamily: "cursive" }}>Ready To Work Together?</h3>
